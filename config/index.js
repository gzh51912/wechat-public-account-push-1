  ...
  USERS: [
    {
      ...
      id: "ooScU5-KwpARW2SYx686gD0Piqag",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oUJyAomrr-zKkeG7QqnRKBzcNKU18QJtXSFBjFEiYxE",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
      // 新历生日, 仅用作获取星座运势, 格式必须
      horoscopeDate: '1996-11-1',
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝", "year": "1996", "date": "11-14"},
        {"type": "节日", "name": "在一起纪念日", "year": "2021", "date": "10-31"}
      ],
      ...
      name: "宝宝",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ooScU5-E8CsXCb1VvFL8rEuVwFVQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "-CAv2pg2OmYrwMfEvA878afxWTlCaadh_WHwdZ3oaSw",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
      // 新历生日, 仅用作获取星座运势, 格式必须
      horoscopeDate: '1996-11-14',
      // 获取什么时候的星座运势，可选：['今日', '明日', '本周', '本月', '今年'], 留空则随机
      horoscopeDateType: '今日',
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
      openUrl: "https://wangxinleo.cn",
